...
class RelationshipCreate:
    ...
    Attributes:
        ...
        inverse_relationship_type (None | str | Unset): Type for the auto-created inverse row (e.g. 'parent' for
            'child'). Inferred when omitted.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        inverse_relationship_type = _parse_inverse_relationship_type(
            d.pop("inverse_relationship_type", UNSET)
        )
