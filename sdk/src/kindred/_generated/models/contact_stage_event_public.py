...
T = TypeVar("T", bound="ContactStageEventPublic")


@_attrs_define
class ContactStageEventPublic:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        contact_stage_event_public = cls(
            occurred_at=occurred_at,
            id=id,
            contact_id=contact_id,
            owner_id=owner_id,
        ...
        contact_stage_event_public.additional_properties = d
        return contact_stage_event_public
