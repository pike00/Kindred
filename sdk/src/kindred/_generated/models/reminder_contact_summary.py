...
T = TypeVar("T", bound="ReminderContactSummary")


@_attrs_define
class ReminderContactSummary:
    """
    Attributes:
        id (UUID):
        first_name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reminder_contact_summary.additional_properties = d
        return reminder_contact_summary
