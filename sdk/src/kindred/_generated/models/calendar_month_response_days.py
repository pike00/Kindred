...
class CalendarMonthResponseDays:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        calendar_month_response_days.additional_properties = additional_properties
        return calendar_month_response_days

    @property
    def additional_keys(self) -> list[str]:
        return list(self.additional_properties.keys())

    def __getitem__(self, key: str) -> list[CalendarEntry]:
        return self.additional_properties[key]

    def __setitem__(self, key: str, value: list[CalendarEntry]) -> None:
