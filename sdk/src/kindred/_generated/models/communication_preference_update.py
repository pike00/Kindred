...
T = TypeVar("T", bound="CommunicationPreferenceUpdate")


@_attrs_define
class CommunicationPreferenceUpdate:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        communication_preference_update = cls(
        ...
        communication_preference_update.additional_properties = d
        return communication_preference_update
