...
class BulkContactRequest:
    ...
    filters: BulkContactFilter | None | Unset = UNSET
    limit: int | Unset = 500
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.filters, Unset):
            filters = UNSET
        elif isinstance(self.filters, BulkContactFilter):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        operations = BulkContactOperation.from_dict(d.pop("operations"))
        ...
        def _parse_filters(data: object) -> BulkContactFilter | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                filters_type_0 = BulkContactFilter.from_dict(data)

                return filters_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(BulkContactFilter | None | Unset, data)

        filters = _parse_filters(d.pop("filters", UNSET))

        limit = d.pop("limit", UNSET)

        bulk_contact_request = cls(
            operations=operations,
        ...
        bulk_contact_request.additional_properties = d
        return bulk_contact_request
