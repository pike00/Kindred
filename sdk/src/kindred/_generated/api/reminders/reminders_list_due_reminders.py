...
from ...models.reminders_due_public import RemindersDuePublic
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = RemindersDuePublic.from_dict(response.json())
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | RemindersDuePublic
    """
