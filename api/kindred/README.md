...
| `dev`   | `https://kindred.khanpikehome.com`    | Homelab deployment.                                        |
...
```
100.119.100.85  kindred.localhost
```

(That's `ares` — replace if you're running the stack elsewhere on the tailnet.)
