...
next_step: Browser-test on the running dev stack (https://kindred.example.com/calendar). Then close out remaining tasks: jump-to-date picker, ICS export link, API doc.
---
