...
def list_contacts_geo(
    session: SessionDep,
    current_user: CurrentUser,
    min_lat: float | None = Query(default=None, description="Minimum latitude for bounding box filter"),
    max_lat: float | None = Query(default=None, description="Maximum latitude for bounding box filter"),
    min_lng: float | None = Query(default=None, description="Minimum longitude for bounding box filter"),
    max_lng: float | None = Query(default=None, description="Maximum longitude for bounding box filter"),
) -> Any:
