...
FIRST_NAMES = [
    "Alex", "Alice", "Amelia", "Anna", "Arjun", "Ben", "Beth", "Cai", "Cara",
    "Chen", "Chloe", "Clara", "Daniel", "Dante", "Diego", "Ella", "Emma",
    "Ethan", "Eva", "Farhan", "Felix", "Finn", "Grace", "Hannah", "Henry",
    "Ian", "Ines", "Isaac", "Isla", "Ivy", "Jack", "Jade", "Jamie", "Jasper",
    "Jin", "Jordan", "Julia", "Kai", "Kavya", "Kenji", "Kiran", "Lara",
    "Leila", "Leo", "Liam", "Lila", "Luca", "Lucas", "Luna", "Maria", "Mateo",
    "Maya", "Mei", "Mia", "Miguel", "Mila", "Nadia", "Naledi", "Nate", "Nia",
    "Niko", "Nora", "Oliver", "Olivia", "Omar", "Priya", "Quinn", "Raj",
    "Riya", "Rosa", "Ruby", "Sam", "Sana", "Sara", "Sasha", "Satoshi", "Simi",
    "Sofia", "Tariq", "Theo", "Uma", "Vera", "Viktor", "Willa", "Xena",
    "Yara", "Yusuf", "Zara", "Zoe",
]

LAST_NAMES = [
    "Abara", "Adams", "Ahmed", "Alvarez", "Andersson", "Arora", "Bailey",
    "Baker", "Bennett", "Bhatt", "Brown", "Cabrera", "Cai", "Campbell",
    "Chen", "Choudhury", "Clark", "Cohen", "Cole", "Cruz", "Davies", "Diaz",
    "Dimitriou", "Duarte", "Evans", "Fernandez", "Fischer", "Foster", "Gao",
    "Garcia", "Ghosh", "Gonzalez", "Green", "Haddad", "Haile", "Hall",
    "Harris", "Hassan", "Hayes", "Hill", "Ikeda", "Ivanov", "Jackson",
    "Jensen", "Johnson", "Jones", "Kapoor", "Khan", "Kim", "Kimura", "Kowal",
    "Lee", "Lopez", "Maeda", "Martin", "Mendoza", "Mitchell", "Moore",
    "Morales", "Moreau", "Nakamura", "Nguyen", "Njoroge", "Novak", "Obi",
    "Okafor", "Park", "Patel", "Perez", "Peterson", "Phillips", "Popov",
    "Price", "Quinn", "Ramos", "Reyes", "Rizzo", "Romero", "Sato", "Schmidt",
    "Sharma", "Silva", "Singh", "Smith", "Suzuki", "Tan", "Taylor", "Thomas",
    "Torres", "Vasquez", "Wang", "Williams", "Wilson", "Wright", "Yamamoto",
    "Zhang",
]

COMPANIES = [
    "Acme", "Aurora Labs", "Beacon Capital", "Cedar Biomedical", "Delta Works",
    "Ember Studio", "Fjord Dynamics", "Globe Logistics", "Harbor Analytics",
    "Indigo AI", "Junction Press", "Kestrel Robotics", "Loam Agritech",
    "Mariner Fintech", "Nimbus Cloud", "Orchard Foods", "Pike Systems",
    "Quartz Media", "Ridgeline Design", "Solstice Energy", "Tidepool", "Umber",
    "Vanguard Legal", "Willow Health", "Xavier Biosciences", "Yonder Games",
    "Zephyr Aerospace",
]

TITLES = [
    "Software Engineer", "Product Manager", "Designer", "Data Analyst",
    "Accountant", "Nurse", "Teacher", "Architect", "Consultant", "Founder",
    "Lawyer", "Marketer", "Writer", "Photographer", "Chef", "Electrician",
    "Researcher", "VP Engineering", "Head of Ops", "Recruiter", "Physician",
    "Veterinarian", "Mechanic", "Civil Engineer", "UX Researcher",
]

DEPARTMENTS = [
    "Engineering", "Design", "Marketing", "Sales", "Operations", "Finance",
    "Legal", "HR", "Research", None, None, None,
]

CITIES = [
    ("Seattle", "WA"), ("Portland", "OR"), ("San Francisco", "CA"),
    ("Los Angeles", "CA"), ("Denver", "CO"), ("Austin", "TX"), ("Dallas", "TX"),
    ("Chicago", "IL"), ("Minneapolis", "MN"), ("Boston", "MA"),
    ("New York", "NY"), ("Brooklyn", "NY"), ("Philadelphia", "PA"),
    ("Atlanta", "GA"), ("Miami", "FL"), ("Nashville", "TN"),
    ("Washington", "DC"), ("Toronto", "ON"), ("Vancouver", "BC"),
    ("London", None), ("Berlin", None), ("Amsterdam", None), ("Lisbon", None),
    ("Tokyo", None), ("Singapore", None), ("Sydney", None),
]

STREETS = [
    "Main St", "Oak Ave", "Pine St", "Maple Ave", "Cedar Ln", "Elm St",
    "Birch Rd", "Chestnut Ave", "Washington Blvd", "Lincoln Ave", "Park St",
    "Lake Dr", "River Rd", "Summit Way", "Hillside Ct", "Meadow Ln",
]

TAG_SPECS = [
    ("Family", "#ef4444"), ("Close Friends", "#f97316"), ("Work", "#3b82f6"),
    ("College", "#8b5cf6"), ("High School", "#a855f7"), ("Book Club", "#10b981"),
    ("Climbing", "#14b8a6"), ("Running Group", "#06b6d4"), ("Neighbor", "#84cc16"),
    ("VIP", "#eab308"), ("Mentor", "#f59e0b"), ("Mentee", "#d97706"),
    ("Referral", "#ec4899"), ("Client", "#0ea5e9"), ("Vendor", "#64748b"),
    ("Investor", "#22c55e"), ("Networking", "#6366f1"), ("Band", "#dc2626"),
    ("Travel", "#0891b2"), ("Kids' Parents", "#f43f5e"),
]
...
RELATIONSHIP_TYPES = [
    ...
    "in-law", "cousin", "friend", "colleague", "mentor", "mentee",
    "roommate", "neighbor",
]
...
PET_NAMES = [
    "Rufus", "Biscuit", "Luna", "Milo", "Bella", "Charlie", "Daisy", "Finn",
    "Hazel", "Oreo", "Peanut", "Pepper", "Scout", "Simba", "Willow",
]
...
INTERACTION_NOTES = [
    "Caught up over coffee.", "Quick check-in call.",
    "Texted about weekend plans.", "Lunch near the office.",
    "Video call — walked through demo.", "Drinks after work.",
    "Ran into each other at the grocery store.", "Birthday call.",
    "Sent a long email catching up.", "Hiked the ridge trail.",
    "Helped them move.", "Debugged their deployment.",
    "Talked through a career decision.", "", "", "",
]

GIFT_IDEAS = [
    "Artisan coffee subscription", "Hand-thrown ceramic mug",
    "Used bookshop gift card", "Board game", "Linen napkins",
    "Local honey sampler", "Cast iron pan", "Climbing gym day pass",
    "Wool socks", "Leather keychain", "Plant", "Vinyl record",
    "Bottle of olive oil", "Cookbook",
]

OCCASIONS = [
    "Birthday", "Christmas", "Hanukkah", "Housewarming", "Wedding",
    "New baby", "Just because", "Anniversary",
]
...
def _email_for(first: str, last: str, company: str | None, idx: int) -> str:
    ...
    if company and random.random() < 0.4:
        slug = (
            company.lower().replace(" ", "").replace(".", "").replace("&", "and")
        )
        domain = f"{slug}.com"
    else:
...
def make_contact(owner_id: uuid.UUID) -> Contact:
    ...
    return Contact(
        ...
        is_archived=False,
        is_deceased=False,
        contact_frequency_days=random.choice(
            [None, None, None, 30, 60, 90, 180, 365]
        ),
...
def run(count: int, email: str, reset: bool, rng_seed: int | None) -> None:
    ...
    with Session(engine) as session:
        ...
        surviving = _all(
            session, select(Contact).where(Contact.owner_id == user.id)
        )
