...
class CustomFieldsResource:
    ...
    ) -> CustomFieldDefinitionsPublic | HTTPValidationError | None:
    ...
    def update_definition(
        self, field_id: UUID, definition: CustomFieldDefinitionUpdate
    ) -> CustomFieldDefinitionPublic | HTTPValidationError | None:
    ...
    async def update_definition_async(
        ...
        return await custom_fields_update_field_definition.asyncio(
            client=self._client, field_id=field_id, json_body=definition
        )
    ...
    ) -> CustomFieldValuesPublic | HTTPValidationError | None:
    ...
    async def list_values_async(
        self, *, contact_id: UUID, skip: int = 0, limit: int = 100
    ) -> CustomFieldValuesPublic | HTTPValidationError | None:
        """Async version of list_values()."""
        from personal_crm_client.api.custom_fields import custom_fields_list_field_values

        return await custom_fields_list_field_values.asyncio(
            client=self._client, contact_id=contact_id, skip=skip, limit=limit
        )
    ...
    async def create_value_async(
        self, value: CustomFieldValueCreate
    ...
    def update_value(
        self, value_id: UUID, value: CustomFieldValueUpdate
    ) -> CustomFieldValuePublic | HTTPValidationError | None:
