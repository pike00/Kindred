...
from ...models.custom_field_value_create import CustomFieldValueCreate
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[CustomFieldValuePublic | HTTPValidationError]:
    return Response(
