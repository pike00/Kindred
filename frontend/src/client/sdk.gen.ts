...
export class ContactsService {
     ...
     * @throws ApiError
     */
    public static uploadAvatar(data: ContactsUploadAvatarData): CancelablePromise<ContactsUploadAvatarResponse> {
        return __request(OpenAPI, {
            method: 'GET',
