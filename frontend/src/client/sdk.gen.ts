...
export class ContactImportsService {
     ...
     * @throws ApiError
     */
    public static googleAuthorize(): CancelablePromise<ContactImportsGoogleAuthorizeResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/contacts/import/google/authorize'
        });
    }
     ...
     * @param data The data for the request.
     * @param data.requestBody
     * @returns OAuthCredentialPublic Successful Response
     * @throws ApiError
     */
    public static googleExchange(data: ContactImportsGoogleExchangeData): CancelablePromise<ContactImportsGoogleExchangeResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/contacts/import/google/exchange',
            body: data.requestBody,
            mediaType: 'application/json',
            errors: {
                422: 'Validation Error'
     ...
     * @throws ApiError
     */
    public static googleSync(): CancelablePromise<ContactImportsGoogleSyncResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/contacts/import/google/sync'
        });
    }
     ...
     * @returns GoogleSyncPreviewResponse Successful Response
     * @throws ApiError
     */
    public static googleSyncPreview(): CancelablePromise<ContactImportsGoogleSyncPreviewResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/contacts/import/google/sync/preview'
        });
    }
}
