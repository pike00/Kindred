...
import type { CancelablePromise ,
    ContactHeatmap } from './core/CancelablePromise';
import { OpenAPI ,
    ContactHeatmap } from './core/OpenAPI';
import { request as __request ,
    ContactHeatmap } from './core/request';
...
export class ContactsService {
     ...
     * @throws ApiError
     */
    public static getContactHeatmap(data: { contactId: string }): CancelablePromise<ContactHeatmap> {
        return __request(OpenAPI, {
            method: 'GET',
