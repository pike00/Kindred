...
### Added
- Feat(contacts): allow entering birthday without a year (#205) (aa0cc8d)

## [0.2.117] - 2026-08-20

### Fixed
- Fix(deps): sync react-dom specifier in pnpm-lock.yaml (bfb6b87)

## [0.2.116] - 2026-08-20

### Other
- Build(docker): install pnpm directly via npm in Dockerfile.prod (f95bd32)
...
### Added
- Feat: move version and hash to sidebar and add dev footer (#204) (13deceb)

## [0.2.113] - 2026-08-20

### Other
- Add fill demo credentials button on local dev (#203) (719904d)
